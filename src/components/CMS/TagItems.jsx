    ...
    return (
        ...
        <div className='flex flex-col justify-start gap-4'>
            ...
            <div className='flex w-full justify-end gap-4'>
                ...
                <button onClick={addInput} class="text-white  bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-44 px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Create New {title}</button>
